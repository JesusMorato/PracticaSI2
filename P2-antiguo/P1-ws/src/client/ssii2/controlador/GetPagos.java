...
//imports necesarios para inicializar un stub
...
public class GetPagos extends ServletRaiz {
    ...
    */
    ...
    throws ServletException, IOException {
		...
		PagoBean[] pagos = dao.getPagos(idComercio).toArray(new PagoBean[0]);       //esto creo que es asi pero hay que mirar que no de error
